      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <Card className="shadow-xl hover:shadow-2xl transition-shadow duration-500 rounded-2xl">
              ...
              <CardContent className="px-8 py-12">
                <form onSubmit={handleContactSubmit} className="space-y-6">
                  ...
                  <Button type="submit" className="w-full text-lg py-4 hover:scale-105 transition-transform duration-300">
                    Send Message
                  </Button>
                </form>
              </CardContent>
