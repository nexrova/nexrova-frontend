...
//             </h2>
//             <p className="text-lg text-muted-foreground mb-8">
//               See how Nexrova can deliver fraud reduction and a modern guest experience for your property.
//             </p>
//             <div className="space-x-4">
//               <Button 
//                 asChild 
...
import { Link } from 'react-router-dom';
// Core Icons
import { Users, Target, Award, Eye, Lock, Zap, Bot, Shield, Plug, DollarSign, TrendingUp, Clock, Tablet, Key, Server, Settings } from 'lucide-react'; 
...
const About = () => {
  ...
  const corePillars = [
    {
      ...
      description: "IoT and AI-powered monitoring eliminate staff fraud, inventory theft, and cash leakages across operations.",
      style: 'primary-border' 
    },
    {
      icon: Zap,
      title: "Full Automation",
      description: "Digitalize operations with AI-powered check-ins, automated cash handling, and real-time inventory management.",
      style: 'gradient-fill' 
    },
    {
      icon: Bot, 
      title: "WhatsApp-First CX",
      description: "Instant, no-app-needed guest service for bookings, orders, and support—the seamless 21st-Century Guest Experience.",
      style: 'default' 
    },
    {
      icon: Plug, 
      title: "Modular & Scalable",
      description: "Plug-and-play modules integrate with existing PMS or act as a custom open-source PMS for small properties.",
      style: 'primary-border' 
    }
  ];

  // New section for detailed product breakdown
  const products = [
    {
        icon: Bot,
        title: "Agentic AI Guest Platform",
        description: "A WhatsApp-first automation suite handling all guest interactions: booking, check-in, service requests, and support, eliminating manual front-desk labor."
    },
    {
        icon: Key,
        title: "IoT Key Box & Automation",
        description: "The Key Box automates physical room key distribution—only the slot for the assigned room opens upon digital check-in. This IoT layer (with RFID/sensors) ensures rooms, linens, and inventory are accounted for, preventing theft and tracking maintenance status."
    },
    {
        icon: Server,
        title: "AI Management Dashboard",
        description: "A real-time data and analytics platform for hotel owners, offering complete visibility into operations, cash flow, and providing real-time alerts for suspicious activity and potential revenue leakage."
    },
    {
        icon: Settings,
        title: "Custom Open-Source PMS",
        description: "A lightweight, custom Property Management System for small properties lacking existing tech, easily deployed and integrated with all Nexrova modules."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-gradient-to-br from-primary/10 to-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Nexrova redefines how hotels and service apartments digitalize operations with AI and IoT, eliminating staff fraud, automating workflows, and delivering a truly <b>21st-Century Guest Experience</b>.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-16 max-w-4xl mx-auto text-center">
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-4">Our Mission</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                To empower every property, regardless of size, to significantly reduce fraud and provide a <b>21st-Century Guest Experience</b> by adopting our affordable, plug-and-play AI and IoT automation platform.
              </p>
            </div>
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-4">Our Vision</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                A future where <b>Revenue Leakage</b> and manual errors are obsolete, enabling hotels to focus entirely on hospitality through real-time visibility and zero-friction digital workflows.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Impact and Market Scale - HIGHLIGHTING THE ₹1 CRORE FIGURE */}
      <section className="py-20 bg-muted/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">The Cost of Manual Operations</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Hotels suffer massive <b>Revenue Leakage</b>—a cost that dwarfs the solution.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <StatCard 
              icon={DollarSign}
              value="₹7-17 Lakhs"
              label="Leakage per ₹1 Crore Turnover"
              description="The hidden cost lost annually due to fraud, theft, and inefficiency in mid-tier properties every ₹1 crore."
            />
            <StatCard 
              icon={Users}
              value="2 Lakhs+"
              label="Target Properties in India"
              description="The market size of independent hotels and service apartments in India desperate for affordable tech."
            />
            <StatCard 
              icon={TrendingUp}
              value="Instant ROI"
              label="Profitability Guarantee"
              description="Our monthly cost is less than what most properties lose to fraud and manual errors in one month."
            />
          </div>
        </div>
      </section>
      ...
      {/* NEW SECTION: Our Products (Detailed Breakdown including IoT Key Box) */}
      <section className="py-20 bg-primary/5">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Our Products: AI & IoT Digitalization</h2>
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                    A modular suite designed to eliminate <b>Revenue Leakage</b>, automate workflows, and empower owners with full visibility.
                </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {products.map((product, index) => (
                    <Card key={index} className="bg-background shadow-lg hover:shadow-xl transition-smooth">
                        <CardContent className="p-6 flex items-start space-x-4">
                            <div className="flex-shrink-0 mt-1">
                                <product.icon className="h-8 w-8 text-primary" />
                            </div>
                            <div>
                                <h3 className="font-bold text-xl mb-2 text-foreground">{product.title}</h3>
      ...
      {/* Our Values Section (Cultural Principles) */}
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Our Values</h2>
      ...
      <section className="py-20 bg-gradient-to-br from-primary/10 to-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              See how Nexrova can deliver <b>Fraud Prevention</b> and a modern <b>21st-Century Guest Experience</b> for your property.
            </p>
            <div className="space-x-4">
              <Button 
                asChild 
